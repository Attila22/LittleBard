...
#region 澶栨澶勭悊
    ...
    /// What effect is used by the label.
    /// </summary>
    private bool m_withOutLine=false;
    public bool HasOutLineStyle
    {
        set
        {
            if (m_withOutLine != value)
            {
                m_withOutLine = value;
                hasChanged = true;
            }
    ...
    public Effect OutLineStyle
    {
        get
        {
            return m_withOutLine ? Effect.Outline : Effect.None;
        }
    }
#endregion
    /// <summary>
