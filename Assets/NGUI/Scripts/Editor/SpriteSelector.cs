...
{
    /// <summary>
    /// 鏂板閫夋嫨绮剧伒濮旀墭 淇敼锛氭睙蹇楃ゥ 2013銆?4銆?4
    /// </summary>
    /// <param name="sprite"></param>
    public delegate void SpriteArrayCallback(string sprite, int ArrayID);
	...
	Callback mCallback;
    SpriteArrayCallback mArrayCallBack;
    int SpriteID;
	float mClickTime = 0f;
    ...
    public void OnSelectSpriteCallBackFuntion(string SpriteName)
    {
        this.mArrayCallBack(spriteName, this.SpriteID);
    }
